			...
			<div class="col-sm-12">
				<table class="table table-bordered table-striped dataTable">
					...
					<tr role="row">
						...
						<th>
							<a href="{{url(route('companies_edit'))}}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> {{trans('Új cég')}}</a>
						</th>
					</tr>
					</thead>
					<tbody>
							...
							<td>
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="{{url(route('companies_view', ['id' => $model->id]))}}"><i class="fa fa-eye"></i> {{trans('Megtekintés')}}</a>
										</li>
										<li>
											<a href="{{url(route('companies_edit', ['id' => $model->id]))}}"><i class="fa fa-edit"></i> {{trans('Szerkesztés')}}</a>
										</li>
										<li class="divider"></li>
										<li>
											<a href="{{url(route('companies_delete', ['id' => $model->id]))}}" class="confirm"><i class="fa fa-trash"></i> {{trans('Törlés')}}</a>
										</li>
									</ul>
								</div>
							</td>
