					...
					@foreach ($list as $model)
						<tr role="row" class="odd">
							...
							<td class="text-right" style="width: 150px;">
								<a href="{{url(route('skills_view', ['id' => $model->id]))}}" class="btn btn-info btn-sm">
									<i class="fa fa-eye"></i>
								</a>
								<a href="{{url(route('skills_edit', ['id' => $model->id]))}}" class="btn btn-primary btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="{{url(route('skills_delete', ['id' => $model->id]))}}" class="btn btn-danger btn-sm confirm">
